...
public class PlayerComparison implements Comparison {
    ...
    public double calculateTrueShootingPercentage(Player player) {
        return (player.getAveragePoints()
                / (2 * (player.getAverageFieldGoalAttempts() + 0.44 * player.getAverageFreeThrowAttempts()))) * 100;
    }
    ...
    public double calculatePER(Player player) {
        ...
        double VOP = player.getAveragePoints() / (player.getAverageFieldGoalAttempts() + player.getAverageTurnovers()
        ...
        double uPER = (1 / player.getAverageMinutesPlayed()) *
                (player.getAveragePoints()
                        ...
                        + (1 - 1.07 * VOP)
                                * (player.getAverageDefensiveRebounds() - player.getAverageOffensiveRebounds()));
