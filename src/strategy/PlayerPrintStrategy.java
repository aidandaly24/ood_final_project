...
public class PlayerPrintStrategy implements PrintStrategy {
        ...
        public void print() {
                ...
                System.out.printf("%-30s %-15.2f %-15.2f\n", "Average Total Rebounds",
                                playerComparison.p1AverageTotalRebounds,
                                playerComparison.p2AverageTotalRebounds);
                System.out.printf("%-30s %-15.2f %-15.2f\n", "Average Field Goal Percentage",
                                playerComparison.p1AverageFieldGoalPercentage,
                                playerComparison.p2AverageFieldGoalPercentage);
                System.out.printf("%-30s %-15.2f %-15.2f\n", "Average 3PFG%",
                ...
                System.out.printf("%-30s %-15.2f %-15.2f\n", "Average Free Throw Percentage",
                                playerComparison.p1AverageFreeThrowPercentage,
                                playerComparison.p2AverageFreeThrowPercentage);
                ...
                System.out.printf("%-30s %-15.2f %-15.2f\n", "Average Minutes Played",
                                playerComparison.p1AverageMinutesPlayed,
                ...
                System.out.printf("%-30s %-15.2f %-15.2f\n", "Average Personal Fouls",
                                playerComparison.p1AveragePersonalFouls,
                ...
                System.out.printf("%-30s %-15.2f %-15.2f\n", "Three Point Reliance",
                                playerComparison.p1ThreePointReliance,
                                playerComparison.p2ThreePointReliance);
                System.out.printf("%-30s %-15.2f %-15.2f\n", "Assist Turnover Ratio",
                                playerComparison.p1AssistTurnoverRatio,
                                playerComparison.p2AssistTurnoverRatio);
                System.out.printf("%-30s %-15.2f %-15.2f\n", "Rebounds Per Minute",
                                playerComparison.p1ReboundsPerMinute,
                                playerComparison.p2ReboundsPerMinute);
                System.out.printf("%-30s %-15.2f %-15.2f\n", "PER", playerComparison.p1PER, playerComparison.p2PER);
                System.out.printf("%-30s %-15.2f %-15.2f\n", "Age Performance Ratio",
                                playerComparison.p1AgePerformanceRatio,
