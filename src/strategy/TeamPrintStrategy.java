...
public class TeamPrintStrategy implements PrintStrategy {
    ...
    public void print() {
        ...
        System.out.printf("%-40s %-20.2f %-20.2f\n", "Average Total Rebounds", teamComparison.t1AverageTotalRebounds,
                teamComparison.t2AverageTotalRebounds);
        System.out.printf("%-40s %-20.2f %-20.2f\n", "Average Field Goal Percentage",
                teamComparison.t1AverageFieldGoalPercentage, teamComparison.t2AverageFieldGoalPercentage);
        ...
        System.out.printf("%-40s %-20.2f %-20.2f\n", "Average Free Throw Percentage",
                teamComparison.t1AverageFreeThrowPercentage, teamComparison.t2AverageFreeThrowPercentage);
        ...
        System.out.printf("%-40s %-20.2f %-20.2f\n", "Average Minutes Played", teamComparison.t1AverageMinutesPlayed,
        ...
        System.out.printf("%-40s %-20.2f %-20.2f\n", "Average Personal Fouls", teamComparison.t1AveragePersonalFouls,
                teamComparison.t2AveragePersonalFouls);
        System.out.printf("%-40s %-20.2f %-20.2f\n", "Average Age", teamComparison.t1AverageAge,
                teamComparison.t2AverageAge);

        // Advanced Statistics
        System.out.printf("%-40s %-20.2f %-20.2f\n", "Estimate Possessions", teamComparison.t1EstimatePossessions,
                teamComparison.t2EstimatePossessions);
        System.out.printf("%-40s %-20.2f %-20.2f\n", "Offensive Efficiency", teamComparison.t1OffensiveEfficiency,
